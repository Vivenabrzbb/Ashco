  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mx-auto max-w-2xl px-6 py-20 text-center">
        ...
        <h1 className="mb-3 font-display text-3xl font-extrabold text-paper">Order received</h1>
        <p className="mb-2 text-ash">
          Invoice <span className="font-bold text-paper">{typedOrder.invoice_number}</span> has
          been emailed to <span className="text-paper">{typedOrder.customer_email}</span>.
        </p>
        <p className="mb-10 text-ash">
          Ashco Wholesale will contact you shortly to confirm the order and arrange payment.
        </p>

        <div className="rounded-2xl border border-line bg-panel p-6 text-left">
          <div className="mb-4 flex items-center justify-between border-b border-line pb-4">
            <span className="font-display font-bold text-paper">Order summary</span>
          ...
          className="mt-8 inline-flex items-center gap-2 rounded-full bg-signal px-6 py-3 font-display font-bold text-ink transition hover:bg-signalDim"
        >
